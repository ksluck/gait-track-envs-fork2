...
def register_humanoid(env_name):
    if env_name == "GaitTrackHumanoid-v0":
        kwargs = {"start_on_belly": False}
    elif env_name == "GaitTrackHumanoidEz-v0":
        kwargs = {"start_on_belly": False, "gravity": -2}
    elif env_name == "GaitTrackCmuHumanoid-v0":
        kwargs = {"start_on_belly": False, "cmu": True}
    elif env_name == "GaitTrackScaledHumanoid-v0":
